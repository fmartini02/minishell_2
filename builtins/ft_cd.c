...
/*   Updated: 2025/07/12 00:01:20 by francema         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../minishell.h"

static void	handle_missing_home(char *home, char *oldpwd, t_mini *shell)
{
...
static void	cd_to_home(t_mini *shell, char *oldpwd)
{
	...
	if (!home || home[0] == '\0')
		return (handle_missing_home(home, oldpwd, shell));
	if (!oldpwd)
		oldpwd = ft_strdup("");
